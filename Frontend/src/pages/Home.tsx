...
export default function Home() {
  ...
  const faqs = [
    { question: "What is PulseAPI?", answer: "PulseAPI is a simple API monitoring tool. Add your endpoint and we continuously check if it's up or down, while tracking response time and failures." },
    { question: "How does monitoring work?", answer: "PulseAPI periodically sends requests to your API endpoint and records the response status and latency. If the endpoint fails or becomes unreachable, it is marked as down in the dashboard." },
    { question: "How often are endpoints checked?", answer: "Endpoints are checked every 30 seconds to detect downtime as quickly as possible without overwhelming your servers." },
    { question: "What kind of endpoints can I monitor?", answer: "Any public HTTP or HTTPS API endpoint can be monitored using PulseAPI." },
    { question: "Do I need to install anything?", answer: "No installation is required. Simply add your API endpoint in the dashboard and monitoring starts automatically." },
    { question: "Is this a production tool?", answer: "PulseAPI is currently a hackathon project built to demonstrate real-time API monitoring and uptime tracking." }
  ];
  ...
  return (
    <>
      ...
      >
        ...
        <motion.h1 variants={itemVariants} style={{ fontFamily: 'var(--font-display)', fontWeight: 700, letterSpacing: '-0.05em' }}>
      ...
      <footer style={{ borderTop: '1px solid var(--border-subtle)', padding: '2rem 4vw', display: "flex", justifyContent: "space-between", alignItems: "center", background: "var(--bg-base)", flexWrap: "wrap", gap: "1rem" }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
          <a href="https://x.com/quantapar" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'var(--text-muted)', fontSize: '0.95rem', transition: 'var(--transition-fast)' }} onMouseOver={(e) => e.currentTarget.style.color = 'var(--text-main)'} onMouseOut={(e) => e.currentTarget.style.color = 'var(--text-muted)'}>
          ...
          <a href="https://github.com/Quantapar" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'var(--text-muted)', fontSize: '0.95rem', transition: 'var(--transition-fast)' }} onMouseOver={(e) => e.currentTarget.style.color = 'var(--text-main)'} onMouseOut={(e) => e.currentTarget.style.color = 'var(--text-muted)'}>
